'''
 Write a recursive Python function, given a non-negative integer N, to count and return the number 
...
This function has to be recursive; you may not use loops! This function takes in one integer and 
returns one integer.
'''
def count7(N):
    '''
